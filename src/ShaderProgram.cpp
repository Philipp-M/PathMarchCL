...
void ShaderProgram::bind() const { glUseProgram(shaderProgramId); }

void ShaderProgram::unbind() const { glUseProgram(0); }

bool ShaderProgram::vertexAttribPointer(const std::string &attribName, GLint size, GLenum type,
                                        GLsizei stride, const GLvoid *data, bool normalize) const {
...
void ShaderProgram::setUniform3f(const std::string &name, GLfloat v0, GLfloat v1,
                                 GLfloat v2) const {
...
void ShaderProgram::setUniform4f(const std::string &name, GLfloat v0, GLfloat v1, GLfloat v2,
                                 GLfloat v3) const {
  glUniform3f(uniformLocation(name), v0, v1, v2);
}
